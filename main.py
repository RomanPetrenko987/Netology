...
# Студенты
student_1 = Student('Первый', 'Первов', 'Муж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Програмирование"]

student_2 = Student('Вторая', 'Вторкина', 'Жен')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Програмирование"]

# Лекторы
lecturer_1 = Lecturer('Лектор', 'Первов')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Лектори', 'Вторая')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Провер', 'Проверкин')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Проверки', 'Вторикна')
